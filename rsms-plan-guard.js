...
var PLAN_GUARD = (function(){
  ...
  var FEATURES = {
    ...
    students_add:         'starter',   // Add students
    staff_add:            'starter',   // Add staff
    fees_record:          'starter',   // Record fee payments
    fees_ledger:          'starter',   // View student ledger
    portal_links:         'starter',   // Generate login links
    portal_passwords:     'starter',   // Manage passwords
    student_portal:       'starter',   // Student portal access
    parent_portal:        'starter',   // Parent portal access

    // ── STANDARD ──────────────────────────────────────────────
    attendance:           'standard',  // Attendance marking + QR
    assignments:          'standard',  // Teacher assignments
    lesson_plans:         'standard',  // Lesson plan submission
    lesson_notes:         'standard',  // Lesson note submission
    broadcast:            'standard',  // Principal broadcast
    hod_review:           'standard',  // HOD approval workflow
    vp_review:            'standard',  // VP approval workflow
    cbt_exam:             'standard',  // CBT student exam
    self_pay:             'standard',  // Parent self-pay (bank transfer)
    fee_schedule:         'standard',  // Fee schedule config

    // ── PREMIUM ───────────────────────────────────────────────
    score_entry:          'premium',   // Teacher score entry
    progress_report:      'premium',   // Progress/mid-term reports
    ct_remarks:           'premium',   // Class teacher remarks on results
    ...
    class_streams:        'premium',   // Class stream/arm config
    qr_codes:             'premium',   // QR code generation + print

    // ── ENTERPRISE ────────────────────────────────────────────
    clock_gps:            'enterprise', // GPS clock-in
    lesson_ai:            'enterprise', // Lesson AI units gifting
    dedicated_db:         'enterprise', // Dedicated Firebase project
    cloud_storage:        'enterprise', // Extended cloud storage
    custom_reg_prefix:    'enterprise', // Custom registration number format
    superadmin:           'enterprise', // Superadmin portal access
    payroll:              'enterprise', // Staff payroll (coming)
    timetable:            'enterprise', // Timetable builder (coming)

    // ── WHITE LABEL ───────────────────────────────────────────
    custom_branding:      'whitelabel', // Custom domain + logo everywhere
    white_label_resell:   'whitelabel', // Resell RSMS under own brand
  };

  // ── PLAN LIMITS ─────────────────────────────────────────────
  var LIMITS = {
    starter:     { students: 100,  staff: 10,  storage_mb: 100  },
    standard:    { students: 300,  staff: 30,  storage_mb: 500  },
    premium:     { students: 1000, staff: 100, storage_mb: 2048 },
    enterprise:  { students: 9999, staff: 500, storage_mb: 99999},
    whitelabel:  { students: 9999, staff: 999, storage_mb: 99999},
  };
